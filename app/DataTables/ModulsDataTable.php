...
class ModulsDataTable extends DataTable
{
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->editColumn('created_at', function (Modul $modual) {
                return  UtilityFacades::dateFormat($modual->created_at);
            })
            ->addColumn('action', function (Modul $modual) {
                return view('moduls.action', compact('modual'));
            });
    }


    public function query(Modul $model)
    {
